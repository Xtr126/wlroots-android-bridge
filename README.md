...
- Here we keep the buffer entirely in GPU for the whole process of rendering/compositing and presenting to display.  
...
* Termux handles the huge amount of dependencies of wlroots, mesa, wayland, labwc, etc for us.
...
Must have app installed on-device for linking against shared libraries at build time.
    ...
    git clone https://github.com/Xtr126/labwc-android
    cd labwc-android
    meson setup build
...
# What works now
2026: Almost complete transition to [labwc](https://github.com/Xtr126/labwc-android)  from [tinywl](https://github.com/Xtr126/tinywl-ANativeWindow/)  
